...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/bifor.png') }}">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
                    ...
                    <ul id="sidebarnav">
                        <li>
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ url('assets/images/bifor.png') }}" alt="users" class="rounded-circle" width="40" /></div>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                <a href="https://github.com/aprianilestariii">Apriani Lestari</a> | XII RPL - SMK Bina Informatika
            </footer>
        </div>
    </div>
	<script>
